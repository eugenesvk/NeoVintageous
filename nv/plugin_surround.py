...
@register_text(['Surroundyss'],seqs.YSS, (NORMAL,))
...
@register_text(['SurroundS'], (VISUAL, VISUAL_LINE, VISUAL_BLOCK))
...
@register_text(['Surroundds'], (NORMAL, OPERATOR_PENDING))
...
@register_text(['Surroundcs'], (NORMAL, OPERATOR_PENDING))
